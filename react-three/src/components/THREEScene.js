...
import { Scene, Raycaster, PerspectiveCamera, Vector3 } from 'three';
...
var THREEScene = createTHREEComponent(
  ...
  THREEObject3DMixin,
  {
    ...
    bindCamera: function(props) {
      ...
      if (typeof camera === 'string') {
        ...
        if (typeof camera === 'undefined') {
          ...
          camera = new PerspectiveCamera( 75, props.width / props.height, 1, 5000 );
    ...
    projectPointerEvent: function (event, eventName, canvas) {
      ...
      var mousecoords = new Vector3(x,y,0.5);
